...
PN532_HSU::PN532_HSU() {
  command = 0;
  // After calling it setSerial() is required
}

void PN532_HSU::setSerial(HardwareSerial &serial) { _serial = &serial; }

void PN532_HSU::setSerial(int8_t rxPin, int8_t txPin) {
  _serial->begin(115200, SERIAL_8N1, rxPin, txPin, false);
}

void PN532_HSU::begin() { _serial->begin(115200); }
